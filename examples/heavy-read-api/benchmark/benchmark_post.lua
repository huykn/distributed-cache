-- Benchmark script for /post endpoint (optimized with OnSetLocalCache callback)
-- Usage: wrk -t4 -c100 -d30s --latency -s benchmark_post.lua <url>
...
function request()
    ...
    return wrk.format("GET", "/post?id=" .. id)
end

function done(summary, latency, requests)
    io.write("\n")
    io.write("=== BENCHMARK RESULTS ===\n")
    io.write("ENDPOINT: /post (Optimized)\n")
