-- Benchmark script for /post-marshal endpoint (re-marshals data on every request)
-- Usage: wrk -t4 -c100 -d30s --latency -s benchmark_post_marshal.lua <url>
...
function request()
    ...
    return wrk.format("GET", "/post-marshal?id=" .. id)
end

function done(summary, latency, requests)
    io.write("\n")
    io.write("=== BENCHMARK RESULTS ===\n")
    io.write("ENDPOINT: /post-marshal\n")
